...
export default defineConfig({
    ...
    projects: [
        ...
        // Bizoholic Frontend Tests
        {
            name: 'bizoholic-frontend',
            use: {
                ...devices['Desktop Chrome'],
                baseURL: process.env.BIZOHOLIC_FRONTEND_URL || 'http://localhost:3000',
            },
            testDir: './tests/bizoholic-frontend',
        },
    ],
    ...
    webServer: process.env.CI ? undefined : [
        ...
        {
            command: 'cd ../../brands/bizoholic/frontend && npm run dev -- --port 3000',
