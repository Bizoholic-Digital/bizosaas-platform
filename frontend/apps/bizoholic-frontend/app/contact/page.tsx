  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submissionData = {
        ...formData,
        source: 'website',
        source_url: 'bizoholic_website',
        submitted_at: new Date().toISOString()
      }

      // Submit to both Wagtail CMS and Django CRM in parallel via FastAPI AI Central Hub
      const [wagtailResponse, crmResponse] = await Promise.allSettled([
        // Submit to Wagtail CMS for content management
        fetch('/api/brain/wagtail/contact', {
          method: 'POST',
          headers: {
        ...
        // Submit to Django CRM for lead management
      ...
      const wagtailSuccess = wagtailResponse.status === 'fulfilled' && wagtailResponse.value.ok
      const crmSuccess = crmResponse.status === 'fulfilled' && crmResponse.value.ok

      if (wagtailSuccess || crmSuccess) {
        ...
        console.log('Contact form submission:', {
          wagtail: wagtailSuccess ? 'success' : 'failed',
