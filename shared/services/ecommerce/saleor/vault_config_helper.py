...
def get_database_config() -> Dict[str, str]:
    ...
    if db_config:
        return {
            ...
            'NAME': db_config.get('database', 'saleor'),
            'USER': db_config.get('username', 'saleor'),
    ...
    return {
        ...
        'NAME': os.getenv('DB_NAME', 'saleor'),
        'USER': os.getenv('DB_USER', 'saleor'),
...
def get_redis_config() -> str:
    ...
    if redis_config:
        return redis_config.get('connection_string', 'redis://redis:6379/1')
        
    return os.getenv('REDIS_URL', 'redis://redis:6379/1')
