...
urlpatterns = [
    ...
    # Custom API endpoints for services and homepage (MUST be before standard API)
    path("api/v2/services/", get_services, name="api_services"),
    path("api/v2/homepage/", get_homepage, name="api_homepage"),
