        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center mb-12">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              From search ads to social campaigns, our AI optimizes every marketing channel
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Google Ads, Bing Ads with AI-powered keyword optimization
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Facebook, Instagram, Twitter campaigns with audience targeting
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  LinkedIn campaigns for B2B lead generation and brand awareness
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Video Advertising</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  YouTube ads, video remarketing, and cross-platform video campaigns
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Mobile Campaigns</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  App install campaigns, mobile-first ad optimization
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Automated email sequences, segmentation, and performance tracking
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Display & Retargeting</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Banner ads, retargeting campaigns across Google Display Network
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">E-commerce Campaigns</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Google Shopping, product listing ads, dynamic remarketing
                </p>
              </CardContent>
            </Card>
          </div>
