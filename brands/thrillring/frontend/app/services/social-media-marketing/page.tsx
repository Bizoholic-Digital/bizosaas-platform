...
import { ArrowLeft, Users, CheckCircle, Star, Calendar, MessageSquare, TrendingUp, Zap, Instagram, Facebook, Twitter, Linkedin, Youtube, Camera, Hash, Video } from 'lucide-react'
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Social Media Campaign Types We Execute
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Strategic social campaigns across all platforms to maximize engagement and reach
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Instagram Campaigns</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Stories, Reels, IGTV, and feed content optimization
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Facebook Marketing</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Posts, Groups, Events, and Facebook Ads management
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">LinkedIn Strategy</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Professional content, thought leadership, and B2B networking
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Twitter Engagement</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Real-time engagement, trending topics, and community building
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">YouTube Content</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Video content strategy, channel optimization, and growth
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Trending hashtags, brand hashtags, and discovery optimization
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Photography, graphics, infographics, and visual storytelling
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Audience engagement, community building, and social listening
                </p>
              </CardContent>
            </Card>
          </div>
