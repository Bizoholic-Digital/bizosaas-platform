        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              SEO Campaign Types We Optimize
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Comprehensive SEO strategies tailored to boost your search rankings and organic traffic
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Strategic keyword research, targeting, and content optimization
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Local SEO Campaigns</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Google My Business optimization, local citations, and geo-targeting
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Site speed optimization, crawlability, and technical infrastructure
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Content SEO</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  SEO-optimized content creation, blog optimization, and content audits
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Mobile-first optimization, responsive design, and mobile usability
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Enterprise SEO</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Large-scale SEO strategies, multi-site optimization, and enterprise solutions
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  High-quality backlink acquisition, link audits, and authority building
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Performance tracking, ranking monitoring, and comprehensive reporting
                </p>
              </CardContent>
            </Card>
          </div>
