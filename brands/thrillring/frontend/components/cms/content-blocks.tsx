...
import { ContentBlock, CallToActionBlock, FeatureBlock, TestimonialBlock, StatsBlock, PricingBlock } from '@/lib/brain-cms'
    ...
    <div className="py-12">
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {value.map((plan, index) => (
          <Card
            key={index}
            className={`relative text-center ${plan.is_popular ? 'border-primary ring-2 ring-primary/20 scale-105' : ''
              }`}
          >
            {plan.is_popular && (
