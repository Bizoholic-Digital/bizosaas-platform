...
export default function CRMDashboardPage() {
  ...
  /*
  const hasCRMAccess = (user?.role as any) === 'super_admin' || 
                       (user?.role as any) === 'sales' || 
                       (user?.role as any) === 'support' ||
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Badge variant="secondary">
                {(user?.role as any) === 'super_admin' ? 'Admin' :
                  (user?.role as any) === 'sales' ? 'Sales' :
                    (user?.role as any) === 'support' ? 'Support' : 'User'}
              </Badge>
              <Button
                variant="outline"
                size="sm"
