/**
 * Bizoholic Contact Page
 * Contact form and office information with Wagtail CMS integration
 */
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Submit to public lead capture API (routes through Brain API Gateway)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Let's Start Your <span className="text-indigo-600">Success Story</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Ready to become addicted to growth? We'd love to hear about your business goals
              and show you how our marketing magic can transform your results.
            </p>
          </div>
        </div>
      </section>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={6}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                    placeholder="Tell us about your business goals, current challenges, and what you'd like to achieve with our help..."
                  />
                </div>
                ...
                >
                  {isSubmitting ? 'Sending...' : 'Start My Success Journey'}
                </button>
              </form>
            </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 mb-1">hello@bizoholic.com</p>
                    <p className="text-gray-600">partnerships@bizoholic.com</p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 mb-1">123 Marketing Street</p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 mb-1">Phone: Same day callback</p>
