...
export default function PricingPage() {
  ...
  const handlePlanSelection = async (planId: string) => {
    ...
    // Integration with FastAPI Brain Gateway for lead capture
    try {
      ...
      console.error('Error tracking pricing interest:', error)
    }
  }
            ...
            <div className="flex items-center justify-center mb-12">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 ${
                  billingPeriod === 'annually' ? 'bg-indigo-600' : 'bg-gray-200'
                }`}
              >
                <span
                  ...
                  <div className="bg-white p-8">
                    <div className={`${isPopular ? 'pt-6' : ''}`}>
                      ...
                      <button
                        ...
                        className={`w-full py-4 px-6 rounded-lg font-medium transition-all duration-200 mb-8 ${
                          isPopular
