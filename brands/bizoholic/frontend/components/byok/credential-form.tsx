...
export function CredentialForm({
  ...
  const handleTest = useCallback(async () => {
    if (!platform || !validateCredentials()) return;
  ...
  }, [platform, validateCredentials, integrationId, testIntegration, credentials, createIntegration, onSuccess]);
  ...
  }, [platform, validateCredentials, integrationId, updateIntegration, credentials, createIntegration, onSuccess]);
