            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="flex items-center gap-2">
                  ...
                  <span className={`capitalize ${connectionState ? 'text-green-600' : 'text-red-600'}`}>
              ...
              <ScrollArea className="h-96">
                <div className="space-y-1 p-3">
                  {notifications.map((notification) => (
                    <div
                      key={notification.id}
                      className={`relative flex gap-3 p-3 rounded-lg border cursor-pointer transition-colors ${notification.read
