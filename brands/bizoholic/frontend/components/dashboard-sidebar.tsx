...
const companyNavigation = [
  {
    ...
    href: process.env.NEXT_PUBLIC_API_BASE_URL || "https://api.bizoholic.net",
    icon: Building,
  ...
  },
  {
    ...
    href: process.env.NEXT_PUBLIC_CLIENT_PORTAL_URL || "https://app.bizoholic.net",
    icon: ShoppingCart,
    description: "AI-powered dropshipping platform",
    external: true,
    category: "frontend"
...
const backendNavigation = [
  {
    ...
    href: process.env.NEXT_PUBLIC_DOKPLOY_URL || "https://dk.bizoholic.com",
    icon: ShoppingCart,
  ...
  },
  {
    ...
    href: process.env.NEXT_PUBLIC_ADMIN_PORTAL_URL || "https://admin.bizoholic.net",
    icon: Palette,
  ...
  },
  {
    ...
    href: process.env.NEXT_PUBLIC_ANALYTICS_URL || "https://analytics.bizoholic.net",
    icon: Bot,
