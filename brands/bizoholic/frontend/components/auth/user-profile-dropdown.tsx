...
const PLATFORM_LINKS = {
  bizoholic: {
    name: 'Bizoholic',
    url: process.env.NEXT_PUBLIC_SITE_URL || 'https://bizoholic.com',
    icon: Zap,
    description: 'AI Marketing Platform'
  },
  coreldove: {
    name: 'CoreLDove',
    url: process.env.NEXT_PUBLIC_CLIENT_PORTAL_URL || 'https://app.bizoholic.net',
    icon: Globe,
    description: 'E-commerce Platform'
  },
  temporal: {
    name: 'Temporal',
    url: process.env.NEXT_PUBLIC_ANALYTICS_URL || 'https://analytics.bizoholic.net',
    icon: Activity,
...
export function UserProfileDropdown() {
  ...
  // For now, allow all platforms - will be tenant-based later
  const availablePlatforms = Object.keys(PLATFORM_LINKS)
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="relative h-10 w-10 rounded-full">
          <Avatar className="h-10 w-10">
            <AvatarImage src={user.avatar || "/placeholder-avatar.png"} alt={getDisplayName()} />
      ...
      <DropdownMenuContent className="w-80" align="end" forceMount>
          ...
          <div className="flex flex-col space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-xs text-gray-500">{user.tenant_name || 'Default Tenant'}</p>
        ...
        {/* Service Access */}
        {user.allowed_services && user.allowed_services.length > 0 && (
          <>
            <DropdownMenuSeparator />
            <DropdownMenuSub>
              <DropdownMenuSubTrigger>
              ...
              <DropdownMenuSubContent className="w-64">
                <div className="p-2">
                  ...
                  {user.allowed_services.map((service) => (
