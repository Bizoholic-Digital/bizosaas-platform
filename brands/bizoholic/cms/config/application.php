 ...
 * A development.php file will override these settings.
 *
 * @package Bedrock
 */
...
$dotenv = Dotenv\Dotenv::createUnsafeImmutable($root_dir, $env_files);
...
// Disable content modification for extra security
