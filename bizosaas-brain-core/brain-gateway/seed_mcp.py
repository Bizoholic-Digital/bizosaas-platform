...
def seed_mcp_registry():
    ...
    try:
        ...
        mcps_data = [
            ...
            {"name": "Shopify", "slug": "shopify", "category_slug": "ecommerce", "description": "All-in-one commerce platform.", "vendor_name": "Shopify Inc", "sort_order": 3, "is_featured": True, "capabilities": ["products", "orders", "customers", "analytics"], "mcp_config": {"type": "docker", "image": "bizosaas/mcp-shopify:latest"}, "is_official": True},
            {"name": "WooCommerce", "slug": "woocommerce", "category_slug": "ecommerce", "description": "Flexible, open-source e-commerce for WordPress.", "vendor_name": "Automattic", "sort_order": 4, "is_featured": True, "capabilities": ["products", "orders", "customers", "coupons"], "mcp_config": {"type": "docker", "image": "bizosaas/mcp-woocommerce:latest"}, "is_official": True},
            ...
            # --- CMS ---
            {"name": "WordPress", "slug": "wordpress", "category_slug": "cms", "description": "The world's most popular website builder.", "vendor_name": "Automattic", "sort_order": 1, "capabilities": ["posts", "pages", "media", "comments", "themes"], "mcp_config": {"type": "docker", "image": "bizosaas/mcp-wordpress:latest"}, "is_official": True},
            ...
            {"name": "FluentCRM", "slug": "fluentcrm", "category_slug": "email-marketing", "description": "Self-hosted email automation for WordPress.", "vendor_name": "WPManageNinja", "sort_order": 3, "capabilities": ["contacts", "campaigns", "tags", "emails"], "mcp_config": {"type": "docker", "image": "bizosaas/mcp-fluentcrm:latest"}, "is_official": True},
            ...
            {"name": "PostHog", "slug": "posthog", "category_slug": "analytics", "description": "Product OS: Analytics, Flags, Session Replays.", "vendor_name": "PostHog", "sort_order": 3, "capabilities": ["events", "recordings", "feature_flags"], "mcp_config": {"type": "docker", "image": "bizosaas/mcp-posthog:latest"}, "is_official": True},
            {"name": "Zoho Analytics", "slug": "zoho-analytics", "category_slug": "analytics", "description": "Self-service BI and analytics platform.", "vendor_name": "Zoho", "sort_order": 4, "capabilities": ["reports", "dashboards", "bi"], "mcp_config": {"type": "docker", "image": "bizosaas/mcp-zoho-analytics:latest"}, "is_official": True},
            ...
            {"name": "GitHub", "slug": "github", "category_slug": "utilities", "description": "Code hosting and version control.", "vendor_name": "Microsoft", "sort_order": 5, "capabilities": ["repos", "issues", "actions"], "mcp_config": {"type": "docker", "image": "bizosaas/mcp-github:latest"}, "is_official": True},
        ]
        
        # Remove old categories that are no longer needed
        obsolete_categories = ["hosting", "hr-payroll", "search", "payments"]
