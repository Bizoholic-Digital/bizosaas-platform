...
from agents.customer_crm_agents import SalesIntelligenceAgent as RefinedSalesIntelligenceAgent
...
class AgentRegistry:
    ...
    def _initialize_agents(self):
        ...
        crm_agents = [
            ...
            ("sales_intelligence", RefinedSalesIntelligenceAgent, "Sales Intelligence", "Advanced sales forecasting and opportunity analysis", ["sales", "forecasting", "deals", "revenue"], "5-10 min", "💹", "#28B463"),
...
class ChatManager:
    ...
    async def _select_best_agent(self, message: str, session: ChatSession) -> str:
        ...
        routing_rules = {
            ...
            "sales_intelligence": ["forecast", "revenue", "deals", "pipeline analysis", "sales report"],
            "ecommerce_specialist": ["store", "shop", "ecommerce", "conversion"],
