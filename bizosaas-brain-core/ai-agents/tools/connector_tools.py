...
class ConnectorTools:
    @tool("Fetch Data from Connector")
    def fetch_data(connector_id: str, resource: str, tenant_id: str = "default_tenant"):
        """
    ...
    @tool("Perform Action on Connector")
    def perform_action(connector_id: str, action: str, payload: str, tenant_id: str = "default_tenant"):
        """
