...
import { Activity, Cpu, Database, Globe, RefreshCw, Server, Shield, Zap, Brain, Users, Layout, ShoppingCart } from 'lucide-react';
            ...
            <Card>
                ...
                <CardContent>
                    <div className="space-y-4">
                        {Object.entries(metrics.services).map(([name, status]) => (
