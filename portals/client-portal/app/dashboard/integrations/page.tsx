...
export default function IntegrationsPage() {
    ...
    // ... handleOAuthConnect and filteredIntegrations
        ...
        <div className="container mx-auto p-6 space-y-8">
            ...
            <Tabs defaultValue="all" className="w-full" onValueChange={setActiveTab}>
                <TabsList className="w-full justify-start bg-slate-900 border border-slate-800 p-0 h-auto flex-wrap">
                    ...
                    <TabsTrigger value="marketing" className="data-[state=active]:bg-blue-600 data-[state=active]:text-white px-4 py-2">Marketing</TabsTrigger>
                        ...
                        <Card key={integration.id} className="bg-slate-900 border-slate-800 flex flex-col hover:border-blue-500/50 transition-colors">
                            ...
                            <CardFooter>
                                <Dialog>
                                    ...
                                    <DialogContent className="bg-slate-900 border-slate-800 text-white sm:max-w-[800px] max-h-[80vh] overflow-y-auto">
                                        <DialogHeader>
                                        ...
                                        {integration.id === 'google_analytics' ? (
                                            <GoogleAnalyticsIntegration
                                                ...
                                                onUpdate={(status) => {
                                                    ...
                                                    // implementation would update 'integrations' state
                                                }}
                                            />
