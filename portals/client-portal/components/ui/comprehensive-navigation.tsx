...
import { getEffectivePermissions, RolePermissions } from '@/utils/rbac';
      ...
      subItems: [
        {
          ...
          show: effectivePermissions.canAccessCRM
        },
        {
          id: 'cms',
          name: 'Content & CMS',
          ...
          show: effectivePermissions.canAccessCMS
        },
        {
          id: 'ecommerce',
          name: 'E-commerce',
          ...
          show: effectivePermissions.canAccessEcommerce
        },
        {
          id: 'support',
          name: 'Help & Support',
        ...
        },
        {
          ...
          show: effectivePermissions.canAccessMarketing
        },
        {
          id: 'seo',
          name: 'SEO & Search',
          ...
          active: pathname.startsWith('/dashboard/seo'),
        },
        {
          id: 'directory',
