            ...
            <div className="space-y-8">
                ...
                <div className="space-y-3 text-left">
                    ...
                    <Select
                        ...
                        disabled
                    >
                        <SelectTrigger className="h-12 rounded-xl border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-sm focus:ring-2 focus:ring-blue-500 opacity-70">
                    ...
                    <p className="text-[10px] text-muted-foreground/60 font-bold uppercase tracking-wider ml-1">
                        System detected from your website analysis.
                    </p>
                </div>
                ...
                <div className="space-y-3 text-left">
                    ...
                    <p className="text-[10px] text-muted-foreground/60 font-bold uppercase tracking-wider ml-1">
                        System detected from your growth stack.
                    </p>
                </div>
