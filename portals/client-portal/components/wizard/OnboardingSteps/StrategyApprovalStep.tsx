                                ...
                                <CardContent className="p-10 space-y-8 relative z-10 text-white">
                                    ...
                                    <div className="pt-6 border-t border-white/10 space-y-6">
                                        <div className="space-y-3">
                                            <Label className="text-[10px] font-black uppercase tracking-widest opacity-60 text-left block">Refine Strategy (Optional Feedback)</Label>
                                            <textarea
                                                className="w-full bg-white/10 border border-white/20 rounded-2xl p-4 text-xs font-medium placeholder:text-white/30 focus:outline-none focus:ring-2 focus:ring-white/40 transition-all min-h-[80px]"
                                                placeholder="e.g. Focus more on LinkedIn than Meta, or prioritize local leads in London..."
                                            />
                                            <Button
                                                variant="outline"
                                                className="border-white/20 hover:bg-white/10 text-white font-bold text-[10px] uppercase h-8 px-4"
                                                onClick={() => {
                                                    setIsGenerating(true);
                                                    setTimeout(() => setIsGenerating(false), 2000);
                                                }}
                                            >
                                                <Sparkles className="w-3 h-3 mr-2" /> Refine with AI
                                            </Button>
                                        </div>
                                        ...
                                        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-4 border-t border-white/10">
                                            ...
                                            {/* Redundant Internal Button Removed - Using Wizard Footer instead */}
                                            <div className="hidden md:flex items-center gap-2 text-[10px] font-bold opacity-60 uppercase tracking-widest">
                                                <ShieldCheck size={14} className="text-green-400" /> Secure Cloud Deployment Enabled
                                            </div>
                                        </div>
                                    </div>
                                </CardContent>
