...
export const AIAgentChat: React.FC = () => {
    ...
    const handleSend = async (text: string = input) => {
        ...
        try {
            const apiRes = await agentsApi.chat('personal_assistant', text);
            ...
            id: (Date.now() + 1).toString(),
                role: 'agent',
                    content: result.message || "I've processed your request. How else can I help?",
                        agentName: result.agent_id === 'personal_assistant' ? 'Personal Assistant' : result.agent_id,
                            timestamp: new Date(),
...
return (
    <div className="flex flex-col h-full w-full bg-slate-900/50 backdrop-blur-xl border border-slate-800/50 shadow-2xl">
        ...
        {/* Input */}
        <div className="p-4 border-t border-slate-800 bg-slate-900/50 pb-20 md:pb-4">
            <form
