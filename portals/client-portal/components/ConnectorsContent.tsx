        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage your integrations with external CMS, CRM, and E-commerce platforms.</p>
                </div>
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogContent>
                    ...
                    <div className="space-y-4 py-4">
                        {selectedConnector && Object.entries(selectedConnector.authSchema).map(([key, field]: [string, any]) => (
