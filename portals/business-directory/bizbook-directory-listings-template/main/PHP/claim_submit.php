                            ...
                            <tr>
                                <td class="content-cell">
                                    <div class="f-fallback">
                                        <h1>Hi, ' . $first_name . '!</h1>
                                        <p>As per your New Claim Request for your ' . $listing_name . ' .We have received your request.</p>
                                        <!-- Action -->
                                        <p>Our Admin team will process your request.You will receive an update with 24 hours.</p >
                                        <!-- Action -->
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td align="center">
                                                                <a href="' . $webpage_full_link . '" class="f-fallback button" target="_blank">Go to ' . $admin_site_name . '</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
