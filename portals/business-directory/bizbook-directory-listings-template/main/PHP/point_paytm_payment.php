...
$contact_name = $user_details_row['user_contact_name'];
$mobile_number = $user_details_row['user_contact_mobile'];
$email_id_new = $user_details_row['user_contact_email'];
...
$CALLBACK_URL = $webpage_full_link.'point_paytm_response';
