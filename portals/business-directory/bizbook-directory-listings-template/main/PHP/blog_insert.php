...
//    blog Insert Part Starts
        ...
        $blog_qry = "INSERT INTO " . TBL . "blogs 
					(user_id, blog_name, blog_description, blog_image, blog_status,  isenquiry, blog_slug, blog_cdt) 
					VALUES 
					('$user_id', '$blog_name', '$blog_description', '$blog_image', '$blog_status', '$isenquiry', '$blog_slug', '$curDate')";
