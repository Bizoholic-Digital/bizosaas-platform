    ...
    <div class="ad-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                <span class="udb-inst">All Service provider Details</span>
                <div class="ud-cen-s2">
                    <h2>All Service provider
                        - <?php echo AddingZero_BeforeNumber(getCountServiceProviderUser()); ?></h2>
                    <?php include "../page_level_message.php"; ?>
                    <div style="display: none" class="static-success-message log-suc"><p>User(s) has been Permanently
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        foreach (getAllTypeUser($service_provider) as $row) {
                            ...
                            <tr>
                                <td><?php echo $si; ?></td>
                                <td><img
                                        src="../images/user/<?php if (($row['profile_image'] == NULL) || empty($row['profile_image'])) {
                                            echo "1.jpg";
                                        } else {
                                            echo $row['profile_image'];
                                        } ?>" alt=""><?php echo $row['first_name']; ?>
                                    <span><?php echo $row['email_id']; ?></span> <span>Join:
                                ...
                                <td><a href="admin-my-profile-edit.php?row=<?php echo $session_user_id; ?>&path=4"
                                       class="db-list-edit">Edit</a></td>
                                <td><a href="admin-my-profile-delete.php?row=<?php echo $session_user_id; ?>&path=4"
                                       class="db-list-edit">Delete</a></td>
                                <td><a href="<?php echo $PROFILE_URL . urlModifier($row['user_slug']); ?>"
                                ...
                                <td><input type='checkbox' class='delete_check'
                                           id='delcheck_<?php echo $session_user_id; ?>' onclick='checkcheckbox();'
                                           value='<?php echo $session_user_id; ?>'></td>
                            </tr>
                            <?php
                            $si++;
                        }
