    ...
    <section>
        <div class="ad-com">
            <div class="ad-dash leftpadd">
				...
				<span class="udb-inst"><?php echo $name[3]['name']; ?> User Details</span>
                <div class="ud-cen-s2">
                    <h2><?php echo $name[3]['name']; ?> Users - <?php echo AddingZero_BeforeNumber(getCountServiceUser(4)); ?></h2>
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        foreach (getAllServiceUser($service_provider, $user_plan) as $row) {
                            ...
                            <tr>
                                ...
                                <td><span class="db-list-rat">$<?php if($user_plan == 0){ echo "0"; }else{echo $plan_type_row['plan_type_price'];} ?></span></td>
                                <td><?php echo $row['user_type']; ?> </td>
                                <td><a href="admin-my-profile-edit.php?row=<?php echo $session_user_id; ?>&path=8" class="db-list-edit">Edit</a></td>
                                <td><a href="admin-my-profile-delete.php?row=<?php echo $session_user_id; ?>&path=8" class="db-list-edit">Delete</a></td>
