    ...
    <div class="ad-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                <span class="udb-inst">All Non Paid User Details</span>
                <div class="ud-cen-s2">
                    <h2>All Non Paid Users - <?php echo AddingZero_BeforeNumber(getCountNonPaidUser()); ?></h2>
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        <?php
                        $si = 1;
                        foreach (getAllNonPaidUser() as $row) {
