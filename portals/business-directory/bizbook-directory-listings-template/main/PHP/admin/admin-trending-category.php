                    ...
                    <table class="responsive-table bordered">
                            ...
                            foreach (getAllTrendCategories() as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="../images/services/<?php echo $row['category_bg_image']; ?>" alt="">
                                    </td>
                                    <td>
                                        <img src="../images/services/<?php echo $row['category_image']; ?>" alt="">
                                    </td>
                                    <td><a href="admin-trending-category-edit.php?row=<?php echo $row['category_id']; ?>" class="db-list-edit">Edit</a></td>
                                </tr>
                                <?php
                                $si++;
                            }
