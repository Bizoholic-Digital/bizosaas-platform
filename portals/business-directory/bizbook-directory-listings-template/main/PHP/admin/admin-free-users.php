    ...
    <div class="ad-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                ...
                <span class="udb-inst"><?php echo $name[0]['name']; ?> User Details</span>
                <div class="ud-cen-s2">
                    <h2><?php echo $name[0]['name']; ?> Users - <?php echo AddingZero_BeforeNumber(getCountServiceUser(1)); ?></h2>
                        ...
                        foreach (getAllServiceUser($service_provider, $user_plan) as $row) {
                            ...
                            <tr>
                                ...
                                <td><img
                                        ...
                                        } ?>" alt=""><?php echo $row['first_name']; ?><span><?php echo $row['email_id']; ?></span>
                                    <span>Join: <?php echo dateFormatconverter($row['user_cdt']); ?></span>
                                </td>
                                ...
                                <td><a href="admin-my-profile-edit.php?row=<?php echo $session_user_id; ?>&path=5"
                                       class="db-list-edit">Edit</a></td>
                                <td><a href="admin-my-profile-delete.php?row=<?php echo $session_user_id; ?>&path=5"
