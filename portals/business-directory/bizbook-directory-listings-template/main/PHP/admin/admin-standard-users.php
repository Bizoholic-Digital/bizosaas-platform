    ...
    <section>
        <div class="ad-com">
            <div class="ad-dash leftpadd">
				...
				<span class="udb-inst"><?php echo $name[1]['name']; ?> user details</span>
                <div class="ud-cen-s2">
                    <h2><?php echo $name[1]['name']; ?> user - <?php echo AddingZero_BeforeNumber(getCountServiceUser(2)); ?></h2>
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        foreach (getAllServiceUser($service_provider, $user_plan) as $row) {
                            ...
                            <tr>
                                ...
                                <td><a href="admin-my-profile-edit.php?row=<?php echo $session_user_id; ?>&path=6" class="db-list-edit">Edit</a></td>
                                <td><a href="admin-my-profile-delete.php?row=<?php echo $session_user_id; ?>&path=6" class="db-list-edit">Delete</a></td>
