...
import { ArrowLeft, Bot, CheckCircle, Star, Mail, Users, BarChart, Zap, Calendar, Target, TrendingUp, MessageSquare, Gift, Clock, UserCheck, Send } from 'lucide-react'
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Email Campaign Types We Master
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Strategic email campaigns designed to nurture leads and drive conversions at every stage
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Onboard new subscribers with personalized welcome sequences
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Product launches, sales announcements, and special offer campaigns
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Lead nurturing workflows that guide prospects through the sales funnel
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Webinar invitations, event promotions, and follow-up sequences
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Automated emails triggered by user actions and behaviors
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Transactional Emails</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Order confirmations, shipping updates, and customer service emails
                </p>
              </CardContent>
            </Card>
          </div>
