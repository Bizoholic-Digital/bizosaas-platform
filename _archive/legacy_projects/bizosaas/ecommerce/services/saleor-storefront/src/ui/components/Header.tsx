...
export function Header({ channel }: { channel: string }) {
	return (
		<header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm">
				...
				<div className="container-custom">
					<div className="flex h-10 items-center justify-between text-sm">
						...
						<div className="flex items-center gap-4">
							<span className="hidden md:inline">🚚 Free shipping on orders $75+</span>
			...
			{/* Mobile-only promotional bar */}
			<div className="bg-yellow-50 border-t border-yellow-200 md:hidden">
				<div className="container-custom">
					<div className="py-2 text-center text-sm text-yellow-800">
						<span className="font-medium">🎉 New customer? Get 15% off your first order!</span>
					</div>
				</div>
			</div>
		</header>
