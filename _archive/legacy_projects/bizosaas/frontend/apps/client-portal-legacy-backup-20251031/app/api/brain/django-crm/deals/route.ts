...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Deals endpoint not available in Brain Hub - using fallback data
    // let url = `${BRAIN_API_URL}/api/brain/django-crm/deals`
    ...
    // Brain Hub doesn't have deals endpoint - using fallback data directly
    console.log('[CLIENT-PORTAL] Using fallback deals data - Brain Hub deals endpoint not available')
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Brain Hub doesn't have deals endpoint - using fallback
    throw new Error('Deals endpoint not available')
    
    const response = await fetch(`${BRAIN_API_URL}/api/brain/django-crm/deals`, {
      method: 'POST',
      headers: {
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${BRAIN_API_URL}/api/brain/django-crm/deals/${deal_id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Host': 'localhost:3000',
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${BRAIN_API_URL}/api/brain/django-crm/deals/${dealId}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        'Host': 'localhost:3000',
