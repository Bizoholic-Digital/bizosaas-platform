...
export async function GET(request: NextRequest) {
  try {
    ...
    let url = `${BRAIN_API_URL}/api/brain/django-crm/activities`
...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${BRAIN_API_URL}/api/brain/django-crm/activities`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Host': 'localhost:3000',
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${BRAIN_API_URL}/api/brain/django-crm/activities/${activity_id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Host': 'localhost:3000',
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${BRAIN_API_URL}/api/brain/django-crm/activities/${activityId}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        'Host': 'localhost:3000',
