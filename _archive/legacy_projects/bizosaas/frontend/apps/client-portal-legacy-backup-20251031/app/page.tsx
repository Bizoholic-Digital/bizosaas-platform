...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive client portal for managing CRM, analytics, e-commerce, and more',
};
...
export default function ClientPortalDashboard() {
  ...
  useEffect(() => {
    // Set document title explicitly for client portal
    document.title = 'Client Portal - Your Business Dashboard';
