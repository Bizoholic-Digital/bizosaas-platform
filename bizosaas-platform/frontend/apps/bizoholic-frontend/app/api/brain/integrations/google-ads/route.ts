...
export async function GET(request: NextRequest) {
  try {
    ...
    const url = new URL(`${BRAIN_API_BASE}/api/integrations/google-ads/campaigns`)
...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${BRAIN_API_BASE}/api/integrations/google-ads/campaigns/create`, {
      method: 'POST',
      headers: {
