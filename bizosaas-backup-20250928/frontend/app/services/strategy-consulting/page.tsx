...
/**
 * Strategy Consulting Service Detail Page
 * Expert marketing strategy consultation to align your business goals with data-driven marketing approaches
 */
...
export default function StrategyConsultingPage() {
  ...
  const fetchServiceData = async () => {
    try {
      ...
      const response = await fetch('/api/brain/wagtail/services?slug=strategy-consulting')
      ...
      setService({
        ...
        features: [
          ...
          "Strategic Marketing Roadmap Development",
        ...
        case_studies: [
          {
            ...
            results: "500% ROI improvement through strategic realignment",
            metrics: "Revenue growth: +250%, Market share: +40%"
          },
          {
            client_name: "FinTech Innovations",
            industry: "Financial Services",
            results: "300% faster market penetration with strategic guidance",
            metrics: "Customer acquisition: +180%, Cost efficiency: +65%"
          }
        ],
        testimonials: [
          {
            client_name: "Rebecca Taylor",
            company: "Strategic Growth Partners",
            quote: "The strategic insights have completely transformed our approach to marketing. We now have a clear roadmap to achieve our goals.",
            rating: 5
          },
          {
            client_name: "James Wilson",
            company: "Innovation Labs",
            quote: "Expert strategy consulting helped us identify opportunities we never knew existed. Our growth has accelerated significantly.",
            rating: 5
          }
        ]
      })
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center space-x-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>85% Goal Achievement Rate</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Strategy Campaign Types Section */}
      <section className="py-16">
        <div className="container">
          <div className="mx-auto max-w-4xl text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Strategy Campaign Types We Develop
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Comprehensive strategic planning across all marketing dimensions
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Deep market research, competitive intelligence, and opportunity identification
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Growth Planning</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Strategic roadmaps for sustainable business growth and market expansion
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Customer Strategy</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Customer journey mapping, persona development, and retention strategies
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Strategic brand positioning, differentiation, and competitive advantage
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Comprehensive business model optimization and strategic planning
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Strategic digital adoption, technology integration, and modernization
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Data-driven market research, consumer insights, and trend analysis
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Implementation Plans</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Detailed execution strategies, timelines, and performance frameworks
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Everything you need for strategic marketing excellence
              </p>
            </div>
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Real results from businesses using strategic consulting
              </p>
            </div>
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg opacity-90">
              Join hundreds of businesses already using strategic consulting to achieve breakthrough growth.
            </p>
            ...
            <div className="mt-8 flex items-center justify-center gap-4">
              <div className="flex items-center space-x-1">
                ...
                <span className="ml-2 text-sm opacity-75">4.9/5 from 250+ reviews</span>
              </div>
            </div>
